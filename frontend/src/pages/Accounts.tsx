                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                                        ...
                                        <div>
                                            ...
                                            <CreatableSelect
                                                ...
                                                value={currencyOptions.find(opt => opt.value === accountCurrency) || { value: accountCurrency, label: accountCurrency }}
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex gap-2">
                                                <button
                                                    type="button"
                                                    className={`flex-1 py-3 px-4 rounded-lg font-medium border-2 transition-all ${categoryType === 'expense'
                                                ...
                                                <button
                                                    type="button"
                                                    className={`flex-1 py-3 px-4 rounded-lg font-medium border-2 transition-all ${categoryType === 'income'
